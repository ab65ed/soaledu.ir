...
export declare const PARSE_APPLICATION_ID: string;
export declare const PARSE_JAVASCRIPT_KEY: string;
export declare const PARSE_MASTER_KEY: string;
export declare const PARSE_SERVER_URL: string;
