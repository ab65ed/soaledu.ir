...
router.get('/enrollment-code/:code', institutionController_1.getInstitutionByEnrollmentCode);
// آمار کلی نهادها
router.get('/stats', auth_1.authenticateToken, (0, auth_1.requireRole)('admin'), institutionController_1.getInstitutionStats);
/**
 * @swagger
 * /api/institutions:
 *   get:
 ...
 */
router.get('/', auth_1.authenticateToken, (0, auth_1.requireRole)('admin'), institutionController_1.getInstitutions);
/**
 * @swagger
 * /api/institutions:
 *   post:
 ...
 */
router.post('/', auth_1.authenticateToken, (0, auth_1.requireRole)('admin'), institutionController_1.createInstitution);
/**
 * @swagger
 * /api/institutions/{id}:
 *   get:
 ...
 */
router.get('/:id', auth_1.authenticateToken, (0, auth_1.requireRole)('admin'), institutionController_1.getInstitutionById);
/**
 * @swagger
 * /api/institutions/{id}:
 *   put:
 ...
 *         description: نهاد یافت نشد
 */
router.put('/:id', auth_1.authenticateToken, (0, auth_1.requireRole)('admin'), institutionController_1.updateInstitution);
/**
 * @swagger
 * /api/institutions/{id}:
 *   delete:
 ...
 *         description: نهاد یافت نشد
 */
router.delete('/:id', auth_1.authenticateToken, (0, auth_1.requireRole)('admin'), institutionController_1.deleteInstitution);
/**
 * @swagger
 ...
 *         description: نهاد یافت نشد
 */
router.get('/:id/students', auth_1.authenticateToken, (0, auth_1.requireRole)('admin'), institutionController_1.getInstitutionStudents);
