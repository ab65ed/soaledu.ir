...
const DefaultDiscountSettingsSchema = new mongoose_1.Schema({
...
const EnrollmentSettingsSchema = new mongoose_1.Schema({
    enrollmentCode: {
        type: String,
...
InstitutionSchema.methods.isEnrollmentValid = function () {
    if (!this.isActive)
        return false;
...
InstitutionSchema.methods.canAcceptMoreStudents = function () {
    if (!this.enrollmentSettings.maxStudents)
        return true;
    return this.studentCount < this.enrollmentSettings.maxStudents;
};
// Static method to find by enrollment code
InstitutionSchema.statics.findByEnrollmentCode = function (code) {
    return this.findOne({
