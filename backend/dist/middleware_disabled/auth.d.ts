...
export declare const authenticateWithRateLimit: (((req: AuthenticatedRequest, res: Response, next: NextFunction) => Promise<void>) | import("express-rate-limit").RateLimitRequestHandler)[];
declare const _default: {
    ...
    authenticateWithRateLimit: (((req: AuthenticatedRequest, res: Response, next: NextFunction) => Promise<void>) | import("express-rate-limit").RateLimitRequestHandler)[];
};
