 ...
 */
const formatZodError = (error: ZodError): { message: string; errors: Array<{ field: string; message: string }> } => {
 ...
 */
export const createErrorResponse = (message: string, statusCode: number = 400, errors?: Array<{ field: string; message: string }>) => {
  return {
    status: 'error',
    statusCode,
    message,
