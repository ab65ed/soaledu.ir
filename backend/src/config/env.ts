...
export const PARSE_APPLICATION_ID = process.env.PARSE_APPLICATION_ID || 'soaledu_app_id';
export const PARSE_JAVASCRIPT_KEY = process.env.PARSE_JAVASCRIPT_KEY || 'soaledu_js_key';
export const PARSE_MASTER_KEY = process.env.PARSE_MASTER_KEY || 'soaledu_master_key';
export const PARSE_SERVER_URL = process.env.PARSE_SERVER_URL || 'http://localhost:1337/parse'; 