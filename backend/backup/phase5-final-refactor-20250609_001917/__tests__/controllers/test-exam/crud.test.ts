...
import { TestExamCrudController } from '../../../controllers/test-exam/crud';
import { TestExamStatus } from '../../../controllers/test-exam/types';
...
describe('TestExamCrudController', () => {
  ...
  describe('create', () => {
    it('should create exam successfully with valid data', async () => {
      ...
      await TestExamCrudController.create(mockReq, mockRes);
  ...
  describe('list', () => {
    it('should return paginated exam list', async () => {
      ...
      await TestExamCrudController.list(mockReq, mockRes);
  ...
  describe('getById', () => {
    it('should return exam by id for authorized user', async () => {
      ...
      await TestExamCrudController.getById(mockReq, mockRes);
  ...
  describe('update', () => {
    it('should update exam successfully', async () => {
      ...
      await TestExamCrudController.update(mockReq, mockRes);
