...
import { ActivityType, UserRole, Permission } from '../models/roles';
 ...
 *                         type: object
 */
router.get('/pricing', ...financeAccess.viewPrices, async (req, res) => {
  try {
 ...
 */
router.put('/pricing', ...financeAccess.manage, logActivity(ActivityType.UPDATE, 'pricing'), async (req, res) => {
  try {
 ...
 *         description: عدم مجوز کافی
 */
router.get('/payments', ...financeAccess.manage, async (req, res) => {
  try {
 ...
 *         description: عدم مجوز کافی
 */
router.post('/payment-requests', ...financeAccess.requestPayment, async (req, res) => {
  try {
 ...
 */
router.post('/payment-requests/:id/approve', ...financeAccess.manage, logActivity(ActivityType.APPROVE, 'payment_request'), async (req, res) => {
  try {
    const { id } = req.params;
 ...
 *         description: درخواست یافت نشد
 */
router.post('/payment-requests/:id/reject', ...financeAccess.manage, logActivity(ActivityType.REJECT, 'payment_request'), async (req, res) => {
  try {
    const { id } = req.params;
 ...
 *         description: عدم مجوز کافی
 */
router.get('/reports/revenue', ...financeAccess.manage, async (req, res) => {
  try {
 ...
 */
router.post('/process-payment', ...financeAccess.processPayment, async (req, res) => {
  try {
