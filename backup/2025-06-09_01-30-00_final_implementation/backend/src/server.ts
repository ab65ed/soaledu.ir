...
// import scalabilityRoutes from "./routes/scalability"; // Database scalability and optimization routes (controller issues)
...
// app.use("/api/v1/scalability", scalabilityRoutes); // Database scalability and optimization routes (controller issues)
