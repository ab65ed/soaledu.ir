...
const isValidName: CustomValidator = (value: string) => {
...
const isStrongPassword: CustomValidator = (value: string, { req }) => {
  if (!value || typeof value !== 'string') {
...
const isValidNationalCode: CustomValidator = (value: string) => {
  if (!value || typeof value !== 'string') {
