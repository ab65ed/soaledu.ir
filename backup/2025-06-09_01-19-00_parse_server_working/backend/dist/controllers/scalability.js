...
exports.getPerformanceMetrics = exports.generateSuggestions = exports.rejectSuggestion = exports.implementSuggestion = exports.getOptimizationSuggestions = exports.deleteIndex = exports.createIndex = exports.getIndexes = exports.getScalabilityOverview = void 0;
const scalability_1 = require("../models/scalability");
 ...
 */
const getScalabilityOverview = async (req, res) => {
    try {
...
exports.getScalabilityOverview = getScalabilityOverview;
/**
...
const getOptimizationSuggestions = async (req, res) => {
    try {
        ...
        filteredSuggestions.sort((a, b) => priorityOrder[b.priority] -
...
exports.implementSuggestion = implementSuggestion;
/**
...
const generateSuggestions = async (req, res) => {
    try {
        ...
        Object.entries(scalability_1.COLLECTION_OPTIMIZATIONS).forEach(([collection, config]) => {
            // پیشنهاد ایندکس‌های جدید
            config.indexes.forEach((indexConfig) => {
                const existingIndex = indexes.find(i => i.collection === collection && i.name === indexConfig.name);
                if (!existingIndex) {
                    const suggestion = {
            ...
            if (config.sharding) {
                const suggestion = {
                    ...
                    priority: 'high',
                    collection,
                    description: `تقسیم collection ${collection}: ${config.sharding.rationale}`,
                    impact: {
                    ...
                    implementation: {
                        command: `sh.enableSharding("exam-edu"); sh.shardCollection("exam-edu.${collection}", ${JSON.stringify(config.sharding.shardKey)})`,
