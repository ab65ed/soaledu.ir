...
// Create course exam
router.post('/', validation.validateCourseExam, CourseExamController.createCourseExam);
// Update course exam
router.put('/:id', validation.validateCourseExamUpdate, CourseExamController.updateCourseExam);
// Delete course exam
...
// Add rating
router.post('/:id/rating', validation.validateRating, CourseExamController.addRating);
