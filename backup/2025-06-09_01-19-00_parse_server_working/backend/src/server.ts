...
// import performanceRoutes from "./routes/performance"; // Performance monitoring routes (controller issues)
// import cacheRoutes from "./routes/cache"; // Cache management routes (depends on Question model)
...
// Temporarily disabled due to TypeScript compilation errors
// app.use("/api/v1/performance", performanceRoutes); // Performance monitoring routes (controller issues)
// app.use("/api/v1/cache", cacheRoutes); // Cache management routes (depends on Question model)
