...
export const COURSE_EXAM_INDEXES: DatabaseIndex[] = [
  {
...
export const QUESTION_INDEXES: DatabaseIndex[] = [
  {
...
export const TEST_EXAM_INDEXES: DatabaseIndex[] = [
  {
...
export const AB_TEST_INDEXES: DatabaseIndex[] = [
  {
...
export const applyOptimizedIndexes = async () => {
  const allIndexes = [
    ...COURSE_EXAM_INDEXES,
    ...QUESTION_INDEXES,
    ...TEST_EXAM_INDEXES,
...
export const monitorIndexPerformance = async () => {
