...
// Answer schema for Result model
...
// Analytics interfaces for Result model
...
export type TicketCategory = string; // Can be made more specific if needed
...
export interface WalletTransaction {
  ...
  amount: number;
  description: string;
  relatedId?: string; // exam id, payment id, etc.
  relatedType?: string; // 'exam', 'payment', etc.
  createdAt: Date;
}
...
// Generic RequestWithUser interface - نسخه واحد و درست
...
// Handler type for Express routes with proper return type
export type RouteHandler<
  ...
  ReqQuery = Query,
  LocalsObj extends Record<string, any> = Record<string, any>
> = (req: RequestWithUser<P, ResBody, ReqBody, ReqQuery, LocalsObj>, res: Response<ResBody, LocalsObj>, next?: NextFunction) => Promise<void> | void;
...
export const asyncHandler = <
  ...
  LocalsObj extends Record<string, any> = Record<string, any>
>(
  fn: (req: RequestWithUser<P, ResBody, ReqBody, ReqQuery, LocalsObj>, res: Response<ResBody, LocalsObj>, next?: NextFunction) => Promise<any>
) => {
  return (req: RequestWithUser<P, ResBody, ReqBody, ReqQuery, LocalsObj>, res: Response<ResBody, LocalsObj>, next?: NextFunction): void => {
