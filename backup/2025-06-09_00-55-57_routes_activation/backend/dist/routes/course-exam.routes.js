 ...
 *                     type: object
 */
router.get('/', ...roles_1.courseExamAccess.read, async (req, res) => {
    try {
 ...
 */
router.post('/', ...roles_1.courseExamAccess.create, (0, roles_1.logActivity)(roles_2.ActivityType.CREATE, 'course_exam'), async (req, res) => {
    try {
 ...
 */
router.get('/:id', ...roles_1.courseExamAccess.withLogging(roles_2.ActivityType.VIEW), async (req, res) => {
    try {
        const { id } = req.params;
 ...
 *         description: درس-آزمون یافت نشد
 */
router.put('/:id', ...roles_1.courseExamAccess.update, (0, roles_1.logActivity)(roles_2.ActivityType.UPDATE, 'course_exam'), async (req, res) => {
    try {
        const { id } = req.params;
 ...
 *         description: درس-آزمون یافت نشد
 */
router.delete('/:id', ...roles_1.courseExamAccess.delete, (0, roles_1.logActivity)(roles_2.ActivityType.DELETE, 'course_exam'), async (req, res) => {
    try {
        const { id } = req.params;
 ...
 */
router.get('/:courseId/questions', ...roles_1.questionAccess.read, async (req, res) => {
    try {
 ...
 *         description: عدم مجوز کافی
 */
router.post('/:courseId/questions', ...roles_1.questionAccess.create, async (req, res) => {
    try {
        const { courseId } = req.params;
