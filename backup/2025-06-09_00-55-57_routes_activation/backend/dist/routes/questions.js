 ...
 * @access  Public
 */
router.get('/search', questionValidation_1.validateQuestionSearch, questionController_1.default.search);
/**
 ...
 * @access  Private
 */
router.post('/', auth_1.authenticateUser, questionValidation_1.validateQuestionCreate, questionController_1.default.create);
/**
 * @route   PUT /api/questions/:id
 * @desc    Update a question
 * @access  Private (owner only)
 */
router.put('/:id', auth_1.authenticateUser, questionValidation_1.validateQuestionUpdate, questionController_1.default.update);
/**
 ...
 * @access  Private (owner only)
 */
router.patch('/:id/auto-save', auth_1.authenticateUser, questionValidation_1.validateQuestionAutoSave, questionController_1.default.autoSave);
/**
