...
exports.ExamPurchaseManagementController = void 0;
const ExamPurchaseCacheService_1 = __importDefault(require("../services/ExamPurchaseCacheService"));
/**
...
class ExamPurchaseManagementController {
    ...
    static async getCacheStats(req, res) {
        try {
            const cacheService = ExamPurchaseCacheService_1.default.getInstance();
     ...
     */
    static async getUserPurchaseStats(req, res) {
        try {
     ...
     */
    static async getExamRepetitionStats(req, res) {
        try {
     ...
     */
    static async generateExamQuestions(req, res) {
        try {
            const { subjectId, categories, difficulty, tags, totalQuestions, examId, isRepetition } = req.body;
     ...
     */
    static async recordExamPurchase(req, res) {
        try {
            ...
            const cacheService = ExamPurchaseCacheService_1.default.getInstance();
            await cacheService.recordExamPurchase(req.user?.id, examId, subjectId, questions);
            res.json({
                success: true,
     ...
     */
    static async clearSubjectCache(req, res) {
        try {
     ...
     */
    static async getUserPurchasedExams(req, res) {
        try {
     ...
     */
    static async testCachePerformance(req, res) {
        try {
...
exports.ExamPurchaseManagementController = ExamPurchaseManagementController;
exports.default = ExamPurchaseManagementController;
//# sourceMappingURL=exam-purchase-management.js.map