 ...
 * ایجاد ایندکس جدید
 */
export declare const createIndex: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
/**
 * حذف ایندکس
 */
export declare const deleteIndex: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
/**
 ...
 */
export declare const implementSuggestion: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
/**
 * رد پیشنهاد بهینه‌سازی
 */
export declare const rejectSuggestion: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
/**
