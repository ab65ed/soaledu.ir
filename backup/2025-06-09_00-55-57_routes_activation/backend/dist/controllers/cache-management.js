...
const QuestionCacheService_1 = __importDefault(require("../services/QuestionCacheService"));
/**
 * کنترلر مدیریت کش
...
class CacheManagementController {
    ...
    static async getCacheStats(req, res) {
        try {
            const cacheService = QuestionCacheService_1.default.getInstance();
     ...
     */
    static async getUserAttemptStats(req, res) {
        try {
     ...
     */
    static async clearCacheByCategory(req, res) {
        try {
     ...
     * GET /api/cache/pools
     */
    static async getCachePools(req, res) {
        try {
            const cacheService = QuestionCacheService_1.default.getInstance();
            const stats = cacheService.getCacheStats();
            res.json({
...
exports.default = CacheManagementController;
