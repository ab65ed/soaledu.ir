...
const answerSchema = new mongoose_1.Schema({
    ...
    selectedAnswer: {
        type: mongoose_1.Schema.Types.Mixed, // Can be string, number, or array for multiple choice
        required: true
    },
    correctAnswer: {
...
const resultSchema = new mongoose_1.Schema({
    ...
    analytics: {
        ...
        fastestQuestion: {
            questionId: mongoose_1.Schema.Types.ObjectId,
            timeSpent: Number
        },
        slowestQuestion: {
            questionId: mongoose_1.Schema.Types.ObjectId,
...
resultSchema.statics.getScoreDistribution = async function (examId) {
